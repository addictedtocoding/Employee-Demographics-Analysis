<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Locations.aspx.cs" Inherits="Project.Locations" %>
...
/*var xmlhttp;		//creates a new variable to be used for ajax purposes
 ...
 //        alert("The latOfC is " + latOfC);
        ...
        var mapOptions =
  {
      ...
      //center: new google.maps.LatLng(latOfC, lngOfC),
...
//plots the office
        ...
        //var currentOfficeLocation = new google.maps.LatLng(latOfC, lngOfC);
        ...
        currentOffice.setMap(map);
         ...
         /* var arr = [];
            ...
            arr.join("")
            alert (arr);
            alert("\"How to add doublequotes\"");
            alert("\" \"");*/
            var q1 = "\"";
            var q2 = "\"";
            var q = q1 + recieve2 + q2;
            //alert(q);                                                                 //R
//var address = "Mathikhere 22/1 Yashwantpura, Bangalore, Karnataka 560041";
var address = q;
//alert(address);                                                                       //R
 var la, ln;
...
geo.geocode({'address':address},function(results, status){
    if (status == google.maps.GeocoderStatus.OK) {              
        ...
        var cOL = new google.maps.LatLng(la, ln);                                       //R (this helps...why???)
var marker4 = new google.maps.Marker({
    position: myLatLng,
    title: 'office'
});
//geocoding test end- successful
//alert(currentOfficeLocation);                                                         //R                                                       
currentOfficeLocation = new google.maps.LatLng(la, ln);
//alert (currentOfficeLocation);
marker4.setIcon('http://maps.google.com/mapfiles/ms/icons/blue-dot.png')
marker4.setMap(map);                                                                    //R
...
lng = ln;
        ...
        alert("Geocode was not successful for the following reason: " + status);
         ...
         var times = new Array();*/
         var locs = new Array();
         var loc1 = currentOfficeLocation;                                                //R (previously currentOfficeLocation)
...
while (k < longitudes.length)
{
    ...
    document.getElementById('<%= Hidden6.ClientID %>').value = lat; 
    document.getElementById('<%= Hidden7.ClientID %>').value = lng;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    Welcome To Employee Demographics Analysis&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;&nbsp;&nbsp; &lt;--------<span class="style4">Note</span>:</p>
    <p style="margin-left: 760px">
        Whenever this button is active, you need to click it.</p>
    </h2>
    <div style="margin-left: 960px">
        <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" 
            ...
            <Items>
                ...
                <asp:MenuItem NavigateUrl="~/scatterplots.aspx" Text="Scatterplots" 
                    Value="Generate Scatterplots"></asp:MenuItem>
                <asp:MenuItem NavigateUrl="~/saveLocations.aspx" 
                    Text="Candidate Locations" Value="(save) Candidate Locations">
                </asp:MenuItem>
